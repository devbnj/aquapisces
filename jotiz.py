...
import math
from jconstant import JConstant
...
class Jotiz(object):
    ...
    def __init__(self):   
        ...
        self.globTithi = ""
        self.globPaksha = ""
        self.globLunarDay = 0L
        self.globLunarDate = ""
        self.globNakshatra = ""
        self.globNakshatra_No = 0L
        self.globNakshatra_Pada = 0L
        ...
        self.globLagnaNum = 0L
        self.globLagnaDeg = 0.0
        self.globBhimFinal = 0L
    ...
    def runCalculations (self, whType, ayanVal):
        ...
        self.findHouses()
        self.calcSaptaVarga()
        for m in xrange(6): self.calculateVargas(m)
